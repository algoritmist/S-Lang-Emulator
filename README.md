...
| 5  | 16     | AddI       | I                   | R-R            | rd <- @rs1 + imm               |
| 6  | 17     | SubI       | I                   | R-R            | rd <- @rs1 - imm               |
| 7  | 18     | MulI       | I                   | R-R            | rd <- @rs1 * imm               |
| 8  | 19     | DivI       | I                   | R-R            | rd <- @rs1 / imm               |
| 9  | 20     | LWM        | I                   | R-M            | rd <- @data[@rs1+imm]          |
| 10 | 21     | SWM        | I                   | R-M            | data[@rs1+imm] <- @rd          |
| 11 | 22     | LWI        | I                   | M-M            | data[@rs1+imm] <- in[@inPtr]   |
| 12 | 23     | SWO        | I                   | M-M            | out[@outPtr] <- data[@rs1+imm] |
| 13 | 4      | JE         | B                   | Branch         | if(@rs1==@rs2) pc <- pc + imm  |
| 14 | 5      | JG         | B                   | Branch         | if(@rs1>@rs2) pc <- pc + imm   |
| 15 | 6      | JNE        | B                   | Branch         | if(@rs1<>@rs2) pc <- pc + imm  |
| 16 | 7      | JL         | B                   | Branch         | if(@rs1<@rs2) pc <- pc + imm   |
| 17 | 31     | JMP        | J                   | Branch         | pc <- @rd + imm                |
